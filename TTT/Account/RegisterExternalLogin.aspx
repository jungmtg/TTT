<%@ Page Title="註冊外部登入" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="TTT.Account.RegisterExternalLogin" Async="true" %>
